    ...
    <>
      <div className='senara-dashboard'>
        <form className='senara-content-sm-login' onSubmit={handleSubmit}>
          ...
          <input className='floating-input:focus~.bar'
            id="email"
            name="email"
            type="text"
            value={values.email}
          ...
          <input className='floating-input:focus~.bar'
            ...
            onChange={handleChange}
          />
          <button className='senara-btn-primary' type="submit">Iniciar Secciòn</button>
          <a className="senara-tagline" href="">¿No tienes cuenta? Registrate</a>
          <a className="senara-tagline" href="">¿Olvidò su contraseña?</a>
          {errorCampos && <p className="alert-senara error"> {errorCampos} </p>}
          {errorEmail && <p className="alert-senara error"> {errorEmail} </p>}
          {valid && <p className="alert-senara success"> {valid} </p>}
        </form>
